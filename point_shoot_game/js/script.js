...
const backgroundcanvas = document.getElementById('backgroundCanvas2');
const backgroundCtx = backgroundcanvas.getContext('2d');
const CANVAS_WIDTH = backgroundcanvas.width = window.innerWidth;
const CANVAS_HEIGHT = backgroundcanvas.height = window.innerHeight;
let gameSpeed = 5;
